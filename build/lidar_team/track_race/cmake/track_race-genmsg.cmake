...
set(MSG_I_FLAGS "-Itrack_race:/home/foscar/ISCC_2023/src/lidar_team/track_race/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/foscar/ISCC_2023/src/lidar_team/track_race/msg/Velocity.msg" NAME_WE)
add_custom_target(_track_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "track_race" "/home/foscar/ISCC_2023/src/lidar_team/track_race/msg/Velocity.msg" ""
)

get_filename_component(_filename "/home/foscar/ISCC_2023/src/lidar_team/track_race/msg/Steering.msg" NAME_WE)
add_custom_target(_track_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "track_race" "/home/foscar/ISCC_2023/src/lidar_team/track_race/msg/Steering.msg" ""
)

get_filename_component(_filename "/home/foscar/ISCC_2023/src/lidar_team/track_race/msg/Test.msg" NAME_WE)
add_custom_target(_track_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "track_race" "/home/foscar/ISCC_2023/src/lidar_team/track_race/msg/Test.msg" ""
)
